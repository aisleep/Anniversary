...
#define MWPHOTO_IMMEDIATELYREFRESHING_NOTIFICATION @"MWPHOTO_IMMEDIATELYREFRESHING_NOTIFICATION"

#define MWPHOTO_NOTIFICATION_INFOKEY_PHOTO @"photo"
#define MWPHOTO_NOTIFICATION_INFOKEY_PROGRESS @"progress"
